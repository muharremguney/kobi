...
<div class="sidebar"> 
        <div class="anasayf">
	    <button id="an" onClick="window.location.reload(false)" style="width:240px; height:50px; color:black; border-style:none; background-color:#FFFFFF;border-radius: 15px; "> ÜRÜN EKLE</button>
	    </div>
...
<div class="content">
	   	...
	   	<div class="bune">
		<form action="spekle.php" method="POST">
		<b>
		<table align="left">
		<tr>
		<td></td>
		<td> <center>
		<font face="Cursive" size="4" color=blue> <i> SİPARİŞ EKLE </i></font>
		</center>
		</td>
		</tr>
		<tr>
        <td> <font face="Cursive" size="4">ÜRÜN İD: </font> </td>
        <td><input type="text" name ="cikis_id" style="width:200px; height:30px; border-style:none;"/></td>
		</tr>
		<tr>
        <td> <font face="Cursive" size="4">ÜRÜN ADI:</font></td>
        <td><input type="text" name ="urun_adi" style="width:200px; height:30px; border-style:none;"/></td>
		</tr>
		<tr>
        <td><font face="Cursive" size="4">ÇIKIŞ MİKTARI:</font><br></td>
        <td><input type="text" name ="cikis_miktar" style="width:200px; height:30px; border-style:none; "/></td>
		</tr>
		<tr>
        <td><font face="Cursive" size="4">ÇIKIŞ TARİHİ:</font></td>
        <td><input placeholder="GG.AA.YYYY" type="text" name ="cikis_tarih" style="width:200px; height:30px; border-style:none;"/></td>
		</tr>
		<tr>
        <td><font face="Cursive" size="4">ÇIKIŞ FİYATI:</font></td>
        <td><input type="text" name ="cikis_fiyat" style="width:200px; height:30px; border-style:none;"/></td>
		</tr>
		<tr>
		<td></td>
