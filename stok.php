...
<td align=center colspan="4"> <font size=4 color=red face='Cursive'> <b> Stoğu Bitenler</td>
	<tr>
		<th bgcolor="#ffffff"><i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ürün Adı&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<th bgcolor="#ffffff"><i>&nbsp;&nbsp;&nbsp;Mevcut Miktarı&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<th bgcolor="#ffffff"><i>Minimum Miktarı&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<th bgcolor="#ffffff"><i>Gerekli Miktar</th>
	</tr>
<?php 
$baglanti=mysqli_connect("localhost","root","","muharrem");
$baglanti->set_charset("utf8");
//echo "<table border='1' width='900px' height='600px' align='center'>";
$sql="SELECT urun.urun_ad, mevcut_stok.mevcut_miktar,mevcut_stok.min_miktar, (mevcut_stok.min_miktar - mevcut_stok.mevcut_miktar) AS olmasi
FROM urun, mevcut_urun, mevcut_stok
WHERE urun.urun_id = mevcut_urun.urun_id AND mevcut_urun.mevcut_id = mevcut_stok.mevcut_id AND (mevcut_stok.mevcut_miktar < mevcut_stok.min_miktar)";
...
while( $sonuc=mysqli_fetch_array($sorgu,MYSQLI_ASSOC) ){
	...
	echo "<td align='center'>"."<font face='Cursive'>".$sonuc["min_miktar"]."</td>";
	echo "<td align='center'>"."<font face='Cursive'>".$sonuc["olmasi"]."</td>";
...
<br><br>
<table border="0" width='800px' height='50px' align="center"> 
<td align=center colspan="4"> <font size=4 color=blue face='Cursive'> <b> Fazla Stok</td>
	<tr>
		<th bgcolor="#ffffff"><i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ürün Adı&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<th bgcolor="#ffffff"><i>&nbsp;&nbsp;&nbsp;Mevcut Miktarı&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<th bgcolor="#ffffff"><i>Minimum Miktarı&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<th bgcolor="#ffffff"><i>Fazla Miktar</th>
	</tr>
<?php 
$baglanti=mysqli_connect("localhost","root","","muharrem");
$baglanti->set_charset("utf8");
//echo "<table border='1' width='900px' height='600px' align='center'>";
$sql="SELECT urun.urun_ad, mevcut_stok.mevcut_miktar,mevcut_stok.min_miktar, (mevcut_stok.mevcut_miktar - mevcut_stok.min_miktar) AS az
FROM urun, mevcut_urun, mevcut_stok
WHERE urun.urun_id = mevcut_urun.urun_id AND mevcut_urun.mevcut_id = mevcut_stok.mevcut_id AND (mevcut_stok.mevcut_miktar > mevcut_stok.min_miktar)";
$sorgu=mysqli_query($baglanti,$sql);
while( $sonuc=mysqli_fetch_array($sorgu,MYSQLI_ASSOC) ){
	...
	echo "<td align='center'>"."<font face='Cursive'>".$sonuc["mevcut_miktar"]."</td>";
	echo "<td align='center'>"."<font face='Cursive'>".$sonuc["min_miktar"]."</td>";
	echo "<td align='center'>"."<font face='Cursive'>".$sonuc["az"]."</td>";
